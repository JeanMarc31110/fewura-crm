...
def main():
    ...
    try:
        if cmd == "seed":
            ...
            con.execute("INSERT INTO prospects(company_name,phone,city,category,lead_score) VALUES(?,?,?,?,?)", ("Hotel WhatsApp Test","0612345678","Toulouse","hotels",90))
            con.commit(); print("OK")
            ...
            out = {
                ...
                "wa": con.execute("SELECT count(*) FROM campaign_recipients WHERE campaign_id=? AND channel='whatsapp'", (cid,)).fetchone()[0],
            }
